...
* **CSS3:** Estilização, layouts modernos (Flexbox/Grid), animações e responsividade.
* **JavaScript:** Manipulação do DOM, eventos e lógica de programação do lado do cliente.
